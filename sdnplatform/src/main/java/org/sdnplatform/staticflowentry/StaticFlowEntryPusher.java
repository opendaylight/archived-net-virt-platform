...
import org.sdnplatform.staticflowentry.web.StaticFlowEntryWebRoutable;
...
public class StaticFlowEntryPusher 
    implements IOFSwitchListener, IModule, IStaticFlowEntryPusherService,
    ...
    void parseRow(Map<String, Object> row, Map<String, Map<String, OFFlowMod>> entries) {
        ...
        OFFlowMod flowMod = (OFFlowMod) controllerProvider.getOFMessageFactory()
    ...
    private void writeOFMessagesToSwitch(long dpid, List<OFMessage> messages) {
        IOFSwitch ofswitch = controllerProvider.getSwitches().get(dpid);
