...
public abstract class ForwardingBase 
    ...
    protected void pushPacket(IOFSwitch sw, OFPacketIn pi, 
                           boolean useBufferId, 
                           short outport, ListenerContext cntx) {
    ...
    protected boolean isInSwitchBroadcastCache(IOFSwitch sw, OFPacketIn pi, ListenerContext cntx) {
        if (sw == null) return true;
        ...
        // Get the hash of the Ethernet packet.
        Ethernet eth =
                IControllerService.bcStore.get(cntx, IControllerService.CONTEXT_PI_PAYLOAD);
    ...
    public static boolean
            blockHost(IControllerService controllerProvider,
        ...
        IOFSwitch sw = 
                controllerProvider.getSwitches().get(sw_tup.getSwitchDPID());
