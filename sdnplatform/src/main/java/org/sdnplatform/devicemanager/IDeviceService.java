...
package org.sdnplatform.devicemanager;
 ...
 * from the {@link ListenerContext} rather than from {@link IDeviceManager}.
 */
public interface IDeviceService extends IPlatformService {
     ...
     */
    public static final ListenerContextStore<IDevice> fcStore = 
        new ListenerContextStore<IDevice>();
