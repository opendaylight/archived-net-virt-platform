...
import org.sdnplatform.linkdiscovery.web.LinkDiscoveryWebRoutable;
import org.sdnplatform.packet.BSN;
...
import org.sdnplatform.util.EventHistory.EvAction;
...
public class LinkDiscoveryManager implements IOFMessageListener,
    ...
    IModule, IInfoProvider, IHAListener {
    ...
    private Command handleLldp(LLDP lldp, long sw, short inPort,
                               boolean isStandard, ListenerContext cntx) {
        ...
        for (LLDPTLV lldptlv : lldp.getOptionalTLVList()) {
            if (lldptlv.getType() == 127 && lldptlv.getLength() == 12
                ...
                remoteSwitch = controllerProvider.getSwitches()
        ...
        if (remoteSwitch == null) {
            // Ignore LLDPs not generated by SDN Platform, or from a switch that
            // has recently
            // disconnected, or from a switch connected to another SDN Platform
            // instance
            if (log.isTraceEnabled()) {
    ...
    public Map<Class<? extends IPlatformService>, IPlatformService> getServiceImpls() {
        Map<Class<? extends IPlatformService>, IPlatformService> m =
                new HashMap<Class<? extends IPlatformService>, IPlatformService>();
    ...
    public void init(ModuleContext context)
        ...
        controllerProvider = context.getServiceImpl(IControllerService.class);
    ...
    public void startUp(ModuleContext context) {
        ...
        discoveryTask = new SingletonTask(ses, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    controllerProvider.terminate();
                } catch (Exception e) {
                    log.error("Exception in LLDP send timer.", e);
                } finally {
                    if (!shuttingDown) {
                        // null role implies HA mode is not enabled.
                        Role role = controllerProvider.getRole();
        ...
        controllerProvider.addOFMessageListener(OFType.PORT_STATUS, this);
