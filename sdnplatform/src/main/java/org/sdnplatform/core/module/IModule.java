...
/**
 * Defines an interface for loadable SDN Platform modules.
 * 
...
public interface IModule {
	 ...
	 * All interfaces must inherit IPlatformService
	 * @return
	 */
	 ...
	 * @return The Collection of IPlatformServices that this module depends
	 *         on.
	 */
	...
	void init(ModuleContext context) throws ModuleException;
	...
	void startUp(ModuleContext context); 
}
