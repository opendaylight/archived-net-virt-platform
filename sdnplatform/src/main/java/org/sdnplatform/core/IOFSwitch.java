...
public interface IOFSwitch {
    ...
    /**
     * Set IControllerProviderService for this switch instance
     ...
     * The message will be handed to the controllerProvider for possible filtering
     * and processing by message listeners
     * @param m   
     * @param bc  
     * @throws IOException  
     */
    public void write(OFMessage m, ListenerContext bc) throws IOException; 
     ...
     * @throws IOException
     */
    public void write(List<OFMessage> msglist, ListenerContext bc) throws IOException;
     ...
     * called by other sdnplatform applications.
     * @param port
     */
