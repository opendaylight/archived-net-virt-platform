 ...
 */
public interface IControllerService extends
        IPlatformService {

    /**
     * A value stored in the listener context containing a parsed packet
     * representation of the payload of a packet-in message. 
     */
    public static final String CONTEXT_PI_PAYLOAD = 
            "org.sdnplatform.core.IControllerProvider.piPayload";
    ...
    /**
     * A ListenerContextStore object that can be used to retrieve the 
     * packet-in payload
     */
    public static final ListenerContextStore<Ethernet> bcStore = 
            new ListenerContextStore<Ethernet>();
     ...
     * @param sw The switch to use for the message
     * @param msg the message to inject
     * @param bContext a listener context to use if required
     * @return True if successfully re-injected, false otherwise
     */
    public boolean injectOfMessage(IOFSwitch sw, OFMessage msg, 
