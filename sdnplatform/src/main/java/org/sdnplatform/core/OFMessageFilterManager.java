...
public class OFMessageFilterManager 
        implements IOFMessageListener, IModule, IOFMessageFilterManagerService {
    ...
    protected IControllerService controllerProvider = null;
    ...
    public HashSet<String> getMatchedFilters(OFMessage m, ListenerContext cntx) {  
        ...
        if (m.getType() == OFType.PACKET_IN) {
            eth = IControllerService.bcStore.get(cntx, 
    ...
    public void startUp(ModuleContext context) {
        ...
        serverPort = 
                Integer.parseInt(System.getProperty("org.sdnplatform." +
                		"packetstreamer.port", "9090"));
        
        controllerProvider.addOFMessageListener(OFType.PACKET_IN, this);
        controllerProvider.addOFMessageListener(OFType.PACKET_OUT, this);
        controllerProvider.addOFMessageListener(OFType.FLOW_MOD, this);
    }
}
