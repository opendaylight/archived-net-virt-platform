...
public class AllowedPortsToBroadcastDomainResource extends ServerResource {
    @Get("json")
    public Map<NodePortTuple, Set<Long>> retrieve() {
        ...
        return topology.getAllowedPortToBroadcastDomains();
    }
}
