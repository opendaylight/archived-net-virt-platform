...
public class AllowedBroadcastResource extends ServerResource {
    @Get("json")
    public Map<OrderedNodePair, NodePortTuple> retrieve() {
        ...
        return topology.getAllowedIncomingBroadcastPorts();
    }
}
