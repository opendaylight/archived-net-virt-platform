 ...
 * exhausted). Once the flows are deleted SDN Platform will re-evaluate the path
 * the traffic should take with it's updated topology map.
 * 
 * @author Jason Parraga
 */

public class PortDownReconciliation implements IModule,
    ...
    public void topologyChanged() {
        for (LDUpdate ldu : topology.getLastLinkUpdates()) {
            if (ldu.getOperation()
                ...
                long affectedSwitch = controllerProvider.getSwitches()
                                                        .get(ldu.getSrc())
                                                        .getId();
    ...
    public Collection<Class<? extends IPlatformService>>
        ...
        Collection<Class<? extends IPlatformService>> l = new ArrayList<Class<? extends IPlatformService>>();
        ...
        if (lds != null) {
            ...
            for (OFMatchReconcile ofmr : ofmRcList) {
                ...
                if (ofmr.rcAction.equals(OFMatchReconcile.ReconcileAction.UPDATE_PATH)) {
                    ...
                    IOFSwitch sw = controllerProvider.getSwitches()
                        ...
                        if (link.getDst() == sw.getId()) {
                            ...
                            for (Entry<Short, List<OFMatch>> invalidBaseIngressAndMatch : invalidBaseIngressAndMatches.entrySet()) {
                                ...
                                if (link.getDstPort() == invalidBaseIngressAndMatch.getKey()) {
                                    ...
                                    neighborSwitches.put(controllerProvider.getSwitches()
                                                                           .get(link.getSrc()),
