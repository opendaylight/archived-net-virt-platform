 ...
 *
 */
public interface IFlowCacheService extends IPlatformService {

    public static final String FLOWCACHE_APP_NAME = 
    		IFlowCacheService.class.getCanonicalName() + "appName";
    public static final String FLOWCACHE_APP_INSTANCE_NAME = 
    		IFlowCacheService.class.getCanonicalName() + "appInstanceName";
     ...
     * ListenerContext information about flowCache.
     */
    public static final ListenerContextStore<String> fcStore = 
     ...
     *
     * @see  org.sdnplatform.flowcache#flowQueryRespHandler
