...
public class OFMessage {
    ...
    public static String getDataAsString(IOFSwitch sw, OFMessage msg, ListenerContext cntx) {
        ...
        switch (msg.getType()) {
            case PACKET_IN:
                ...
                // If the conext is not set by sdnplatform, then ignore.
                if (cntx != null) {
    ...
    public static byte[] getData(IOFSwitch sw, OFMessage msg, ListenerContext cntx) {
