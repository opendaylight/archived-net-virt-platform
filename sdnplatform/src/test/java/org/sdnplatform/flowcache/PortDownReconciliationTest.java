...
import org.sdnplatform.flowcache.PortDownReconciliation;
...
public class PortDownReconciliationTest extends PlatformTestCase {
    ...
    protected Capture<ListenerContext> bc1, bc2, bc3, bc4;
    ...
    public void setUp() throws Exception {
        ...
        bc1 = new Capture<ListenerContext>(CaptureType.ALL);
        ...
        bc2 = new Capture<ListenerContext>(CaptureType.ALL);
        ...
        bc3 = new Capture<ListenerContext>(CaptureType.ALL);
        // Capture the parameters passwed when sw1.write is invoked
        ...
        bc4 = new Capture<ListenerContext>(CaptureType.ALL);
        // Capture the parameters passed when sw1.write is invoked
        ...
        fm = ((OFFlowMod) mockControllerProvider.getOFMessageFactory()
        ...
        fm2 = ((OFFlowMod) mockControllerProvider.getOFMessageFactory()
