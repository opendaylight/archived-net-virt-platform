 ...
 */
public class LinkDiscoveryManagerTest extends PlatformTestCase {
    ...
    public void testRemovedSwitch() {
        ...
        IOFSwitch sw1 = getMockControllerProvider().getSwitches().get(1L);
        IOFSwitch sw2 = getMockControllerProvider().getSwitches().get(2L);
    ...
    public void testHARoleChange() throws Exception {
        ...
        getMockControllerProvider().dispatchRoleChanged(Role.SLAVE, Role.MASTER);
