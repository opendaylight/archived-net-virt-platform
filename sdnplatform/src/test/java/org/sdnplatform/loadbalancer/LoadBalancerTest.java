...
import org.sdnplatform.loadbalancer.ILoadBalancerService;
import org.sdnplatform.loadbalancer.LBMember;
import org.sdnplatform.loadbalancer.LBPool;
import org.sdnplatform.loadbalancer.LBVip;
import org.sdnplatform.loadbalancer.LoadBalancer;
import org.sdnplatform.loadbalancer.MembersResource;
import org.sdnplatform.loadbalancer.PoolsResource;
import org.sdnplatform.loadbalancer.VipsResource;
...
public class LoadBalancerTest extends PlatformTestCase {
    ...
    public void setUp() throws Exception {
        ...
        lb.init(fmc);
        getMockControllerProvider().init(fmc);
        ...
        lb.startUp(fmc);
        getMockControllerProvider().startUp(fmc);
    ...
    public void testTwoSubsequentIcmpRequests() throws Exception {
     ...
     arpRequestPacketIn1 = 
             ((OFPacketIn) getMockControllerProvider().getOFMessageFactory().
     ...
     arpReplyPacketOut1 = 
             (OFPacketOut) getMockControllerProvider().getOFMessageFactory().
